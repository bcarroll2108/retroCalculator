...
SWIFT_CLASS("_TtC10Retro_Calc11AppDelegate")
...
SWIFT_CLASS("_TtC10Retro_Calc14ViewController")
...
- (void)viewDidLoad;
- (IBAction)numberPressed:(UIButton * _Null_unspecified)btn;
- (IBAction)onDividePressed:(id _Nonnull)sender;
- (IBAction)onMultiplyPressed:(id _Nonnull)sender;
- (IBAction)onSubtractPressed:(id _Nonnull)sender;
- (IBAction)onAddPressed:(id _Nonnull)sender;
- (IBAction)onEqualPressed:(id _Nonnull)sender;
- (void)playSound;
